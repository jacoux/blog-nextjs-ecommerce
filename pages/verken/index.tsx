...
import { getClient, getSettings, getExploreAndMoreStories, getAllExploreSlugs, getAllExplore } from "lib/sanity.client";
...
const filteredExplore = activeButton === "Alles"
        ? explore
        : explore.filter(ex => ex.category && ex.category.includes(activeButton));
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {filteredExplore.map((ex) => (
                         ...
                         <a className="bg-gray-50 rounded-lg overflow-hidden" href={'/verken/' + ex.slug}>
                                <div className="relative h-72">

                                <img
                                    className="h-72 w-full object-cover"
                                    src={urlForImage(ex.coverImage).height(1000).width(2000).url()}
                                    alt=""
                                />
