        ...
        <div className="flex flex-col items-center justify-center py-6 px-4 gap-4 text-center">
          ...
          <div className="flex items-center justify-start w-full gap-4 mb-4">
            ...
            >
              ...
              >
                <path
                  d="M8 15C8.84757 14.4022 10.3969 14 12 14C13.6031 14 15.1524 14.4022 16 15M5 11C6.48324 9.8044 9.19456 9 12 9C14.8054 9 17.5168 9.8044 19 11M3 7C4.90703 5.2066 8.39301 4 12 4C15.607 4 19.093 5.2066 21 7M13 19C13 19.5523 12.5523 20 12 20C11.4477 20 11 19.5523 11 19C11 18.4477 11.4477 18 12 18C12.5523 18 13 18.4477 13 19Z"
                  stroke=""
                  stroke-width="1.6"
                  stroke-linecap="round"
                ></path>
            ...
            >
              ...
              >
                <path
                  d="M16 14C14.8954 14 14 14.8954 14 16C14 17.1046 14.8954 18 16 18C17.1046 18 18 17.1046 18 16C18 14.8954 17.1046 14 16 14ZM16 14V7M9 4L3 4M9 12H3M9 8H5M21 16C21 18.7614 18.7614 21 16 21C13.2386 21 11 18.7614 11 16C11 14.3643 11.7857 12.9122 13 12V6C13 4.34315 14.3431 3 16 3C17.6569 3 19 4.34315 19 6L19.0005 12C20.2147 12.9122 21 14.3644 21 16Z"
                  stroke=""
                  stroke-width="1.6"
                  stroke-linecap="round"
            ...
            >
              ...
              >
                <path
                  d="M17 8C17 9.65685 13.4183 11 9 11C4.58172 11 1 9.65685 1 8M17 12C17 13.6569 13.4183 15 9 15C4.58172 15 1 13.6569 1 12M17 16C17 17.6569 13.4183 19 9 19C4.58172 19 1 17.6569 1 16M17 4C17 5.65685 13.4183 7 9 7C4.58172 7 1 5.65685 1 4C1 2.34315 4.58172 1 9 1C13.4183 1 17 2.34315 17 4Z"
                  stroke=""
                  stroke-width="1.6"
                  stroke-linecap="round"
                ></path>
